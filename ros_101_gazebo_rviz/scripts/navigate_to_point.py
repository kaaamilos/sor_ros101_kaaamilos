...
class NavigateAvoid():
    def __init__(self):
        ...
        # we will publish total command to vehicle
    ...
    def avoid_obstacle(self):
        '''
        Based on current ranges, calculate the command
        '''
        break_action = 1.0
        steer_action = 0.0
...
if __name__ == '__main__':
    rospy.init_node('naviagte_avoid')
